    ...
    <div>
      ...
      <div className="absolute left-[350px] right-0 top-[80px] bottom-0 font-mono px-20 py-12 overflow-auto">
        <div className="flex flex-row pb-14 items-end">
          ...
          <Menu>
            <MenuButton className="flex justify-end h-9 w-60 self-center py-2 pl-5 pr-3 text-base font-medium text-center text-gray-900 border-gray-900 border-y-[1.5px] border-r-[1.5px] rounded-r-xl stroke-gray-900">
              <svg
                width="20"
                height="20"
                viewBox="0 0 20 20"
            ...
            <MenuItems
              anchor="bottom"
              className="w-56 mt-3 border border-gray-300 rounded-lg text-center font-mono bg-white"
            >
              <MenuItem>
